...
PHASES = [
    ...
    ("30% Design", "Ampacity"),
    ("30% Design", "Grounding (Step/Touch)"),
    ("30% Design", "Load Flow / Reactive Power"),
    ("30% Design", "Short Circuit"),

    ("60% Design", "Design Drawings"),
    ("60% Design", "Ampacity"),
    ("60% Design", "Grounding (Step/Touch)"),
    ("60% Design", "Energy Loss"),
    ("60% Design", "Load Flow / Reactive Power"),
    ("60% Design", "Illumination"),
    ("60% Design", "Short Circuit"),
    ("60% Design", "Lightning Risk Assessment"),
    ("60% Design", "Insulation Coordination / TOV"),

    ("90% / IFP", "Design Drawings"),
    ("90% / IFP", "Ampacity"),
    ("90% / IFP", "Grounding (Step/Touch)"),
    ("90% / IFP", "Energy Loss"),
    ("90% / IFP", "Load Flow / Reactive Power"),
    ("90% / IFP", "Short Circuit"),
    ("90% / IFP", "Insulation Coordination / TOV"),

    ("IFC", "Design Drawings"),
    ("IFC", "Ampacity"),
    ("IFC", "Arc Flash"),
    ("IFC", "Grounding (Step/Touch)"),
    ("IFC", "Energy Loss"),
    ("IFC", "Load Flow / Reactive Power"),
    ("IFC", "Illumination"),
    ("IFC", "Short Circuit"),
    ("IFC", "Insulation Coordination / TOV"),

    ("Record", "Record Drawings"),
    ("Record", "Ampacity"),
    ("Record", "Arc Flash"),
    ("Record", "Grounding (Step/Touch)"),
    ("Record", "Energy Loss"),
    ("Record", "Load Flow / Reactive Power"),
    ("Record", "Illumination"),
    ("Record", "Short Circuit"),
    ("Record", "Insulation Coordination / TOV"),
